...
// ================================================================
// OTOMATIS PASANG TOMBOL FILE EXPLORER (SOLUSI CLAUDE)
// ================================================================
// Kode ini otomatis nempel tombol "Files" biru setiap kali daftar project kelar dimuat
if (typeof window.applyFiltersAndSort === "function") {
  const originalApply = window.applyFiltersAndSort;
  window.applyFiltersAndSort = function (...args) {
    originalApply(...args);
    setTimeout(() => {
      if (typeof attachFileExplorerButtons === "function") attachFileExplorerButtons();
    }, 50);
  };
} else {
  // Cadangan pemicu saat web pertama kali dibuka
